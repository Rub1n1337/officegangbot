...
const EN: Record<string, string> = {
  ...
  'Discord-бот для порядка на сервере': 'The Discord bot that keeps your server in order',
  'Модерация, авто-модерация, тикеты, уровни и аналитика — в одном боте с чистой панелью управления.': 'Moderation, AutoMod, tickets, levels and analytics — one bot with a clean dashboard.',
  'Открыть панель': 'Open dashboard',
  'Добавить на сервер': 'Add to Server',
  'Ваш сервер —': 'Your server,',
  'на автопилоте': 'on autopilot',
  'Бесплатно • Русский и English • Настройка за минуты': 'Free • Russian & English • Set up in minutes',
  'ВОЗМОЖНОСТИ': 'FEATURES',
  'Всё для управления сообществом': 'Everything to run your community',
  'Авто-модерация': 'AutoMod',
  'Предупреждения, нумерованные кейсы, временные наказания и апелляции на бан.': 'Warnings, numbered cases, temporary punishments and ban appeals.',
  'Анти-спам, фильтры слов, блокировка ссылок и страйки — защита 24/7.': 'Anti-spam, word filters, link blocking and strikes — protection 24/7.',
  'Поддержка с приоритетами, транскриптами и авто-закрытием по неактивности.': 'Support with priorities, transcripts and auto-close on inactivity.',
  'XP за активность, роли за уровни, множители и таблица лидеров.': 'XP for activity, level roles, multipliers and a leaderboard.',
  'Тренды активности, хитмап по часам и готовые выводы по данным.': 'Activity trends, an hourly heatmap and ready-made insights.',
  'Тёплая встреча новичков, авто-роли и настраиваемые сообщения.': 'A warm welcome for newcomers, auto-roles and custom messages.',
  'Ловит всплески заходов и автоматически применяет меры к волне.': 'Catches join spikes and acts on the raid wave automatically.',
  'Гейт для новичков: роль выдаётся только после подтверждения.': 'A gate for newcomers: the role is granted only after verification.',
  'Готовы навести порядок?': 'Ready to get organized?',
  'Добавьте бота за пару кликов и настройте всё в одной панели.': 'Add the bot in a couple of clicks and configure everything in one dashboard.',
  ...
  'Свой футер на эмбедах': 'Custom embed footer',
  'Авто-бэкапы конфигурации': 'Automatic config backups',
  'Продвинутая аналитика и экспорт': 'Advanced analytics & export',
